...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
  ...
  function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterPage = /*#__PURE__*/function () {
      function RegisterPage(formBuilder, navCtrl, toast, apiService) {
      ...
      _createClass(RegisterPage, [{
        ...
        value: function registerUser() {
          ...
          this.apiService.registerUser(user).subscribe(function (data) //Start Service
          {
            console.log(data);
            ...
            if (data.success) {
              ...
              _this.toast.show("Successfully Register", '5000', 'bottom').subscribe(function (toast) {
                console.log(toast);
              });
              ...
              _this.toast.show(data.message, '5000', 'bottom').subscribe(function (toast) {
                console.log(toast);
              });
            }
          }, function (err) {
