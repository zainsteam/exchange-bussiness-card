...
/* harmony import */ var _add_card_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-card.page */ "./src/app/add-card/add-card.page.ts");
...
/* harmony import */ var _add_manual_card_add_manual_card_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../add-manual-card/add-manual-card.page */ "./src/app/add-manual-card/add-manual-card.page.ts");
...
let AddCardPage = class AddCardPage {
    constructor(modalController, barcodeScanner, apiService, toast, navCtrl) {
    ...
    api(input, id) {
        this.apiService.cardAddbyCode(input, id)
            .subscribe((data) => //Start Service
         {
            ...
            this.toast.show(err.statusText, '5000', 'bottom').subscribe(toast => {
                console.log(toast);
            });
...
AddCardPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./add-card.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/add-card/add-card.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./add-card.page.scss */ "./src/app/add-card/add-card.page.scss")).default]
    })
], AddCardPage);
